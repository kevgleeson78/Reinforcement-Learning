...
%% Change these:
\newcommand{\projecttitle}{Reinforcement Learning - A Browser Based Visualisation Tool}
\newcommand{\projectauthor}{Kevin Gleeson}
\newcommand{\projectadvisor}{Mr Martin Hynes}
